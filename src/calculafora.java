 ...
 * @author DELL
 */
public class calculafora extends javax.swing.JFrame {
int num,num2;
String signo;
    /**
     * Creates new form calculafora
     */
    public calculafora() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Label1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 255)));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        num=Integer.parseInt(Label1.getText());
        signo="/";
        Label1.setText("");
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        // TODO add your handling code here:
        num2=Integer.parseInt(Label1.getText());
        switch(signo){
            case "+":
                Label1.setText(Integer.toString(num+num2));
                break;
                case "-":
                Label1.setText(Integer.toString(num-num2));
                break;
                ...
                break;
                       case "log":
               Label1.setText("");
			Label1.setText(String.valueOf((Math.log10(num) / Math.log10(num2))));
                break;
                case "10":
               Label1.setText(String.valueOf(Math.pow(num,num2)));
                break;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(calculafora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new calculafora().setVisible(true);
            }
        });
    }
